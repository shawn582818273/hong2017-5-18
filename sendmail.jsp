...
<div align="center">
	  ...
	  <p></p>
	  <input type="text" name="email" placeholder="email" class="form-control" style= "color:red;margin: 0px; width: 200px; height: 40px; ">
	  <p></p>
	  
      <p align="center">&nbsp;</p>
	
      <input name="register"  class="btn btn-large btn-success" type="submit"  value="找回密码"/>
