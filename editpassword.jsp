...
<div align="center">
	...
	<%--mysql_select.jsp --%>
	<form id="form1" name="form1" method="post" action="editpassword2.jsp" onsubmit="return check()">
	<input name=newpassword " type="password" placeholder="newpassword" style=" width: 180px;"" class="form-control">
	<p></p>
<p><input name="Submit" type="submit" class="btn btn-large btn-success" value="确定" /></p>
</form>
	  <p align="center">&nbsp;</p>
	</div>
	<p align="center">&nbsp;</p>
