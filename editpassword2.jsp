...
<div align="center">
	...
	<%--mysql_select.jsp --%>
<%String newp="update users set password="+request.getParameter("newpassword")+" where number="+request.getSession().getAttribute("sessionname");
